 ...
 @media (max-width: 1400px) {
  ...
  @media (max-width: 800px) {
    ...
    &::-webkit-scrollbar {
      ...
      height: 9px; /* Altura del scroll horizontal */
     }

  &::-webkit-scrollbar-track {
      background: #fff; /* Color de fondo de la pista */
      border-radius: 10px; /* Bordes redondeados */
    }

  &::-webkit-scrollbar-thumb {
      background: #731428; /* Color del "pulgar" del scroll */
      border-radius: 10px; /* Bordes redondeados */
    }
...
const Modal = () => {
    ...
    //Obtenemos la comprobación del estado actual del modal, la información de su video correspondiente
    //la función para cerrarlo y el manejo de errores del formulario
                    ...
                    <DialogEstilizado open>
                        ...
                        <CustomForm onSubmit={handleSubmit} autoComplete="off">
                          ...
                          <div className="buttons-container">
                            <Button color='var(--red-color)' borde='2px solid red' boxShadow={true}>Guardar</Button>
